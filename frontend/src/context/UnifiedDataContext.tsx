...
import { mergeControllerClients, mergeCueQueueEvents, mergeQueuedEvents as mergeQueuedEventsPure, resolveQueuedCompanionLockReplayState, resolveQueuedCompanionLockReplayCallbackState, type CueQueuedEvent, type QueuedEvent } from '@ontime/local-sync-arbitration'
...
// Re-exported from ./control-lock-reducers for backward compatibility with existing importers.
export {
  resolveControllerLockState,
  reduceControlDisplacementsForLockUpdate,
  resolveLockAuthoritySource,
