...
import { WINDOW_MESSAGE_SPECS, windowMessageEvent } from './overlay-debug-events.js'

export { WINDOW_MESSAGE_SPECS, windowMessageEvent } from './overlay-debug-events.js'
