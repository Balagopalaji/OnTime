...
- The current standalone release contract is `docs/spec/standalone-powerpoint-video-timer.spec.md`; live Windows evidence remains on the ISSUE-001 feature branch until the source PR lands.
